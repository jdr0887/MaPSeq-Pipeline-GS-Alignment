...
public class GSAlignmentMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(GSAlignmentMessageListener.class);

    public GSAlignmentMessageListener() {
        super();
    }
