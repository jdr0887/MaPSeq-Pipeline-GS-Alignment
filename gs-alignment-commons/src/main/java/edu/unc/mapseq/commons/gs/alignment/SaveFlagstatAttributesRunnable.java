...
public class SaveFlagstatAttributesRunnable implements Runnable {
    ...
    public void run() {
        ...
        if (workflow == null) {
            logger.error("GSAlignment workflow not found");
            return;
        }
        ...
        for (Sample sample : sampleSet) {
            ...
            File flagstatFile = WorkflowUtil.findFileByJobAndMimeTypeAndWorkflowId(this.mapseqDAOBeanService,
                    sample.getFileDatas(), SAMToolsFlagstat.class, MimeType.TEXT_STAT_SUMMARY, workflow.getId());
